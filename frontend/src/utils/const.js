...
export const BREADCRUMB = {
  ...
  ADD_PRODUCT: MANAGEMENT_PAGE.PRODUCT_MANAGEMENT.SUB.ADD_PRODUCT,

  SHOP_MANAGEMENT: MANAGEMENT_PAGE.SHOP_MANAGEMENT.LABEL,
  STORE_INFORMATION: MANAGEMENT_PAGE.SHOP_MANAGEMENT.SUB.STORE_INFORMATION,
  EDIT_BANNER: MANAGEMENT_PAGE.SHOP_MANAGEMENT.SUB.EDIT_BANNER,
